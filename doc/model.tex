...
\section{Package: stcextend }
  ...
  \label{sect:stcextend.HRFrame}
    ...
    \subsubsection{HRFrame.low}
      ...
      \textbf{type: \hyperref[sect:stcextend.STCFilter]{cabmsd:stcextend.STCFilter}} \newline
      \textbf{multiplicity: 1} \newline 
      Low energy band
  ...
  \subsection{STCFilter}
  \label{sect:stcextend.STCFilter}
    Photometric filter description, compliant with photDM

    \subsubsection{STCFilter.name}
      \textbf{vodml-id: stcextend.STCFilter.name} \newline
      \textbf{type: \hyperref[sect:ivoa]{ivoa:string}} \newline
      \textbf{multiplicity: 1} \newline 
      Filter name

    \subsubsection{STCFilter.zeroPointFlux}
      \textbf{vodml-id: stcextend.STCFilter.zeroPointFlux} \newline
      \textbf{type: \hyperref[sect:ivoa]{ivoa:real}} \newline
      \textbf{multiplicity: 1} \newline 
      Zero point flux of the filter

    \subsubsection{STCFilter.magnitudeSystem}
      \textbf{vodml-id: stcextend.STCFilter.magnitudeSystem} \newline
      \textbf{type: \hyperref[sect:ivoa]{ivoa:string}} \newline
      \textbf{multiplicity: 1} \newline 
      Magnitude system used by the filter

    \subsubsection{STCFilter.effectiveWavelength}
      \textbf{vodml-id: stcextend.STCFilter.effectiveWavelength} \newline
      \textbf{type: \hyperref[sect:ivoa]{ivoa:real}} \newline
      \textbf{multiplicity: 1} \newline 
      Effective wavelength of the filter

    \subsubsection{STCFilter.unit}
      \textbf{vodml-id: stcextend.STCFilter.unit} \newline
      \textbf{type: \hyperref[sect:ivoa]{ivoa:Unit}} \newline
      \textbf{multiplicity: 1} \newline 
      Wavelength unit used for that filter

    \subsubsection{STCFilter.bandWidth}
      \textbf{vodml-id: stcextend.STCFilter.bandWidth} \newline
      \textbf{type: \hyperref[sect:ivoa]{ivoa:real}} \newline
      \textbf{multiplicity: 1} \newline 
      Band width of the filter

  \subsection{STCShape}
  \label{sect:stcextend.STCShape}
    Measure giving the shape of a source

    \subsubsection{STCShape.shape}
      \textbf{vodml-id: stcextend.STCShape.shape} \newline
      \textbf{type: \hyperref[sect:ivoa]{ivoa:string}} \newline
      \textbf{multiplicity: 1} \newline 
      String serialization of the source shape

  \subsection{STCShapeSys}
  \label{sect:stcextend.STCShapeSys}
    Coordinate systen to be used for shape measure

    \subsubsection{STCShapeSys.shapeFrame}
      \textbf{vodml-id: stcextend.STCShapeSys.shapeFrame} \newline
  ...
  \subsection{STCSphericalSkyPosition}
  \label{sect:stcextend.STCSphericalSkyPosition}
    Measure to used for sky points expressed with a spherical coordinate system

    \subsubsection{STCSphericalSkyPosition.coord}
      \textbf{vodml-id: stcextend.STCSphericalSkyPosition.coord} \newline
      \textbf{type: \hyperref[sect:stcextend.STCSphericalPoint]{cabmsd:stcextend.STCSphericalPoint}} \newline
      \textbf{multiplicity: 1} \newline 
      Coordinate of spherical sky position

  \subsection{STCStatus}
  \label{sect:stcextend.STCStatus}
    Measure to be used for status parameters

    \subsubsection{STCStatus.coord}
      \textbf{vodml-id: stcextend.STCStatus.coord} \newline
      \textbf{type: \hyperref[sect:stcextend.STCStatusState]{cabmsd:stcextend.STCStatusState}} \newline
      \textbf{multiplicity: 1} \newline 
      Coordinate holding the statsu value

  \subsection{STCStatusSys}
  \label{sect:stcextend.STCStatusSys}
    Coordinate system to be used for statur measures.

    \subsubsection{STCStatusSys.statusLabel}
      \textbf{vodml-id: stcextend.STCStatusSys.statusLabel} \newline
      \textbf{type: \hyperref[sect:stcextend.StatusLabel]{cabmsd:stcextend.StatusLabel}} \newline
      \textbf{multiplicity: 0..*} \newline 
      Composition loink to all possible status values for this system

  \subsection{StatusLabel}
  \label{sect:stcextend.StatusLabel}
    Possible value of a status

    \subsubsection{StatusLabel.value}
      \textbf{vodml-id: stcextend.StatusLabel.value} \newline
      \textbf{type: \hyperref[sect:ivoa]{ivoa:integer}} \newline
      \textbf{multiplicity: 1} \newline 
      Status value

    \subsubsection{StatusLabel.label}
      \textbf{vodml-id: stcextend.StatusLabel.label} \newline
      \textbf{type: \hyperref[sect:ivoa]{ivoa:string}} \newline
      \textbf{multiplicity: 1} \newline 
      Label attached to that status value

  \subsection{STCSphericalPoint}
  \label{sect:stcextend.STCSphericalPoint}
  Coordinate of a point on the sky sphere expressed in spherical coordinates.

  \subsection{STCStatusState}
  \label{sect:stcextend.STCStatusState}
