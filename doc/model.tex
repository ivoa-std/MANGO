...
\section{Model: mango }
  ...
  \label{sect:AssociatedMangoObject}
    ...
    \subsubsection{AssociatedMangoObject.role}
      \textbf{vodml-id: AssociatedMangoObject.role} \newline
      \textbf{type: \hyperref[sect:MangoInstanceRole]{mango:MangoInstanceRole}} \newline
      \textbf{multiplicity: 0..1} \newline 
      Role of the associated Mango Source

    \subsubsection{AssociatedMangoObject.associatedMangoObject}
      \textbf{vodml-id: AssociatedMangoObject.associatedMangoObject} \newline
  ...
  \subsection{DataDock (Abstract)}
  \label{sect:DataDock}
    Abstract reference to a particular dataset associated to the Source. These data set have a life cycle different from the this of the Mango object. This class is used to specify the type of the dataset as well as its role.

    \subsubsection{DataDock.semantic}
      \textbf{vodml-id: DataDock.semantic} \newline
    ...
    \subsubsection{DataDock.description}
      \textbf{vodml-id: DataDock.description} \newline
  ...
  \label{sect:MangoObject}
    ...
    \subsubsection{MangoObject.parameters}
      \textbf{vodml-id: MangoObject.parameters} \newline
      \textbf{type: \hyperref[sect:Parameter]{mango:Parameter}} \newline
      \textbf{multiplicity: 0..*} \newline 
      Composition link pointing on all parameters attached to the source.

    \subsubsection{MangoObject.dataDock}
      \textbf{vodml-id: MangoObject.dataDock} \newline
      \textbf{type: \hyperref[sect:DataDock]{mango:DataDock}} \newline
      \textbf{multiplicity: 0..*} \newline 
      Link pointing on all data associated with the source. This is an association because associated data have likely their proper live cycles.
  ...
  \label{sect:VOModelInstance}
    ...
    \subsubsection{VOModelInstance.modelInstance}
      ...
      \textbf{multiplicity: 1} \newline 
      Link pointing on one VO instance instance associated with the source. This is an association because associated instances have likely their proper live cycles
