...
photometric filters are imported from \texttt{PhotDM}. 
  \subsection{PhotometricProperty}
    ...
    \textbf{type: \hyperref[sect:error.PropertyError]{mango:error.PropertyError}} \newline
    \textbf{multiplicity: 1} \newline
    Error on the \texttt{PhotometricProperty}.
...
\section{Package: epoch}
  ...
  \subsection{Years}
    ...
    Extension of \texttt{TimeInstant} for time expressed in decimal year (e.g. 2012.75).

  \subsection{Seconds}
    \label{sect:epoch.Seconds}
    Extension of \texttt{TimeInstant} for time expressed in decimal seconds (e.g. UNIX time: 1765432987.7).
