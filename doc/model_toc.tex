...
\section{Package: error}
  ...
  \subsection{ErrorSym1D}
    \label{sect:error.ErrorSym1D}
    Symmetrical error for 1D parameters

    \subsubsection{ErrorSym1D.sigma}
    \textbf{vodml-id: error.ErrorSym1D.sigma} \newline
    \textbf{type: \hyperref[sect:ivoa]{ivoa:RealQuantity}} \newline
    \textbf{multiplicity: 1} \newline
    Amplitude of the symmetrical error on a one-dimensional parameter

  \subsection{ErrorAsym1D}
    \label{sect:error.ErrorAsym1D}
    Asymmetrical error for 1D parameters

    \subsubsection{ErrorAsym1D.high}
    \textbf{vodml-id: error.ErrorAsym1D.high} \newline
    \textbf{type: \hyperref[sect:ivoa]{ivoa:RealQuantity}} \newline
    \textbf{multiplicity: 1} \newline
    High limit for the asymmetrical error for 1D parameters

    \subsubsection{ErrorAsym1D.low}
    \textbf{vodml-id: error.ErrorAsym1D.low} \newline
    \textbf{type: \hyperref[sect:ivoa]{ivoa:RealQuantity}} \newline
    \textbf{multiplicity: 1} \newline
    Low limit for the asymmetrical error for 1D parameters

  \subsection{ErrorEllipse}
    \label{sect:error.ErrorEllipse}
    Elliptical errror for 2D parameters such as the sky positions.

    \subsubsection{ErrorEllipse.semiMajorAxis}
    \textbf{vodml-id: error.ErrorEllipse.semiMajorAxis} \newline
    \textbf{type: \hyperref[sect:ivoa]{ivoa:RealQuantity}} \newline
    \textbf{multiplicity: 1} \newline
    Half of the ellipse major axis

    \subsubsection{ErrorEllipse.semiMinorAxis}
    \textbf{vodml-id: error.ErrorEllipse.semiMinorAxis} \newline
    \textbf{type: \hyperref[sect:ivoa]{ivoa:RealQuantity}} \newline
    \textbf{multiplicity: 1} \newline
    Half of the ellipse minor axis

    \subsubsection{ErrorEllipse.angle}
    \textbf{vodml-id: error.ErrorEllipse.angle} \newline
    \textbf{type: \hyperref[sect:ivoa]{ivoa:RealQuantity}} \newline
    \textbf{multiplicity: 1} \newline
  ...
  \subsection{ErrorSym2D}
    \label{sect:error.ErrorSym2D}
    Symmetrical error for 2D quantities.

    \subsubsection{ErrorSym2D.sigma1}
    \textbf{vodml-id: error.ErrorSym2D.sigma1} \newline
    \textbf{type: \hyperref[sect:ivoa]{ivoa:RealQuantity}} \newline
    \textbf{multiplicity: 1} \newline
    Error on the first dimension (right ascension in case of sky coordinates)

    \subsubsection{ErrorSym2D.sigma2}
    \textbf{vodml-id: error.ErrorSym2D.sigma2} \newline
    \textbf{type: \hyperref[sect:ivoa]{ivoa:RealQuantity}} \newline
    \textbf{multiplicity: 1} \newline
