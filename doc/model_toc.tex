...
combined with great spectroscopic capabilities, making it possible to link star positions
with velocities, each in three dimensions, thus defining a 6-dimensional astrometric solution,
tagged with the epoch when the parameters were set. 

The enormous scientific impact of this mission justifies the fact that the MANGO EpochPostion
