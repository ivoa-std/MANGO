...
\section{Package: dataorigin}
  ...
  \subsection{DataOrigin}
    ...
    \textbf{vodml-id: dataorigin.DataOrigin.ivoid} \newline
    \textbf{type: \hyperref[sect:ivoa]{ivoa:string}} \newline
    \textbf{multiplicity: 1} \newline
    ...
    \textbf{vodml-id: dataorigin.DataOrigin.creators} \newline
    \textbf{type: \hyperref[sect:ivoa]{ivoa:string}} \newline
    \textbf{multiplicity: 0..*} \newline
    ...
    \subsubsection{DataOrigin.license}
    \textbf{vodml-id: dataorigin.DataOrigin.license} \newline
  ...
  \subsection{QueryOrigin}
    ...
    \textbf{vodml-id: dataorigin.QueryOrigin.dataOrigin} \newline
