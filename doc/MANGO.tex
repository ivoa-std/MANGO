...
% GILLLES proposal:
%
%VizieR provides science ready catalogues coming from space agencies and articles. 
%The data published handles a very large set of measures in position, photometry, redshift, source type, etc. depending of the data origin. 
%Content can be observation, simulation, model, compilation, etc. The most frequent are observation tables which can serialize a single object to one or more records.
%
