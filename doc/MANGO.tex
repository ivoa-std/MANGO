...
It also reuses PhotDM and proposes its own classes for the quantities 
...
\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
    ...
    \item Independent Quantities: Each table row is treated as a set of independent quantities.
\end{itemize}
\hfill \break
