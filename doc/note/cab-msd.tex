...
I%f must be possible to provide the TAP server with the VO-DML identifiers attached to all of these tables. This can be done with either the TAP\_SCHEMA or with some external resources.
